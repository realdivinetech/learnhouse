...
interface ImportTypeSelectorProps {
  onSelectType: (type: 'scorm' | 'DigitalBridge') => void
  ...
  return (
    <div className="min-w-[400px] py-2">
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* DigitalBridge Import Option */}
        <button
          onClick={() => onSelectType('DigitalBridge')}
        ...
        >
          ...
          <h3 className="font-semibold text-gray-900 mb-1">
            {t('courses.import.DigitalBridge_courses')}
          </h3>
          <p className="text-sm text-gray-500 text-center">
            {t('courses.import.DigitalBridge_description')}
          </p>
        </button>
      </div>
    </div>
